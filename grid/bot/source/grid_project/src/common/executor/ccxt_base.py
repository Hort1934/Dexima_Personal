...
class CCXTCryptoExecutor(AbstractExecutorWithConnector):
    ...
    def amount_to_precision(self, amount: float, symbol: str) -> Optional[float]:
        return self.connector.amount_to_precision(symbol, amount)

    def price_to_precision(self, price: float, symbol: str) -> Optional[float]:
    ...
    async def _connect(self) -> None:
        ...
        self.connector.set_sandbox_mode(False)  # prod one
