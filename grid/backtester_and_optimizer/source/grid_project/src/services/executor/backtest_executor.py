...
class BacktestExecutor(AbstractExecutor):
    ...
    async def __aexit__(
        ...
        # print(self.result())
        # {'Initial balance': 50.0, 'Available balance': 51.71357256133158, 'Profit': 1.7135725613315813,
        #  'Total trades': 32, 'Long trades': 11, 'Long TP': 8, 'Long SL': 3, 'Short trades': 21, 'Short TP': 14,
        #  'Short SL': 6, 'Fees paid': 0.13139999999999996}
        return None
