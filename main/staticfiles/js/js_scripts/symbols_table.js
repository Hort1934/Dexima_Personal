...
async function getSymbolInfo() {
    try {
        ...
        // Список пар, которые вы хотите получить
        const desiredPairs = ["BTCUSDT", "ETHUSDT", "SOLUSDT", "DOGEUSDT", "ADAUSDT", "TRXUSDT", "XRPUSDT", "VETUSDT", "ETCUSDT",
            "LTCUSDT",
            "DOTUSDT", "BATUSDT", "RVNUSDT", "KAVAUSDT", "WAVESUSDT", "LINKUSDT", "MATICUSDT", "AVAXUSDT",
            "ATOMUSDT",
            "XMRUSDT", "FILUSDT", "NEOUSDT",
            "BCHUSDT", "UNIUSDT", "XLMUSDT", "RUNEUSDT", "ICPUSDT", "LDOUSDT", "HBARUSDT", "APTUSDT"];
